...
> This file describes the main pages of the PerthPins application.
...
| Check-in Detail  | `checkin_details.html` | Full view of a single check-in post                 |
...
- **Core Features:** View all check-ins on an interactive map; browse recent posts; navigate to create a new check-in.

### Explore (`explore.html`)
- **Purpose:** Help users discover check-ins that match their interests.
- **Core Features:** Filter check-ins by various conditions; search by keyword.
...
- **Core Features:** Submit a check-in with a place name, location pin, photos, category, star rating, and description.

### User Profile (`profile.html`)
- **Purpose:** Give users a personal space to review their own activity and manage saved content.
- **Core Features:** View personal stats; browse own check-ins; browse saved check-ins from other users.

### Leaderboard (`leaderboard.html`)
- **Purpose:** View user rankings.
